        ...
        <?php if($data = $venue->getDataVenue($_GET['id_venue'])){ ?>
            <section>
                <div class="py-4 px-4 lg:py-8">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 ">Edit venue #<?= $data['id_venue'] ?> - <?= $data['venue'] ?></h2>
                    <form method="post" enctype="multipart/form-data">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                <label class="block mb-2 text-sm font-medium text-gray-900 ">Nama venue</label>
                                <input type="text" name="venue" value="<?= $data['venue'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5     :ring-blue-500 :border-blue-500" placeholder="<?= $data['venue'] ?>" autocomplete="off">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="tarif" value="<?= $data['tarif'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5      :ring-blue-500 :border-blue-500" placeholder="<?= $data['tarif'] ?>" autocomplete="off">
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="deskripsi" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500     :ring-blue-500 :border-blue-500" placeholder="<?= $data['description'] ?>" autocomplete="off"><?= $data['description'] ?></textarea>
                            </div>
                        </div>
                        <a href="daftar_venue" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-slate-700 rounded-lg focus:ring-4 focus:ring-slate-200 :ring-slate-900 hover:bg-slate-800">
                            Kembali
                        </a>
                        ...
                        <div id="confirmModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
                                    ...
                                    <p class="mb-2 mt-1 font-semibold text-gray-500 "><i class="fa-regular fa-triangle-exclamation mx-2"></i>Update venue #<?= $data['id_venue'] ?> ?</p>
            ...
            <section>
                <div class="py-25 px-4 mx-auto max-w-screen-xl lg:px-6">
                    <div class="mx-auto max-w-screen-sm text-center">
                        <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-blue-600 "><i class="fa-regular fa-cloud-question"></i></h1>
                        <p class="mb-1 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl ">Venue tidak ditemukan</p>
                        <p class="mb-2 text-lg font-light text-gray-500 ">Venue mungkin telah dihapus atau dipindahkan.</p>
                        <a href="daftar_venue" class="inline-flex text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center :ring-blue-900 my-4">Kembali ke daftar</a>
                    </div>   
                </div>
            </section>
        <?php } ?>
