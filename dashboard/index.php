    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <div class="flex items-center justify-start bg-white pl-15 rounded-lg shadow-sm h-32 md:h-64">
            <div>
                ...
                <h3 class="mb-2 text-gray-500 dark:text-gray-400">Pesanan masuk</h3>
                <p class="flex ml-1 text-amber-600 items-end text-2xl font-bold dark:text-amber-600">
        ...
        <div class="flex items-center justify-start bg-white pl-15 rounded-lg shadow-sm h-32 md:h-64">
            <div>
                ...
                <h3 class="mb-2 text-gray-500 dark:text-gray-400">Booking aktif</h3>
                <p class="flex ml-1 text-blue-600 items-end text-2xl font-bold dark:text-blue-500">
            ...
            <div class="flex items-center justify-start bg-white pl-15 rounded-lg shadow-sm h-32 md:h-64">
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-400">Pesanan selesai</h3>
                    <p class="flex ml-1 text-green-600 items-end text-2xl font-bold dark:text-green-500">
