                    ...
                    <tr>
                        ...
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            ...
                            <?php elseif($status == 'expired'): ?>
                                <dd class="inline-flex items-center rounded bg-gray-200 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-900 dark:text-gray-300">
                        ...
                        <section>
                            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                                <div class="mx-auto max-w-screen-sm text-center">
                                    <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-blue-600 dark:text-blue-500"><i class="fa-regular fa-folder-open"></i></h1>
