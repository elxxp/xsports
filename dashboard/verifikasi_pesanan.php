    ...
    <table id="table_verifikasi_pembayaran" class="text-xs">
            ...
            <?php if($getOrders->num_rows > 0): ?>
                <?php $ordinal = 0; foreach($getOrders as $order): $ordinal++; $bukti_tipe_file = "image/jpeg"; $bukti_data = base64_encode($order['bukti']); ?>
                    ...
                    <tr>
                        ...
                        <td class="font-bold text-gray-900 whitespace-nowrap ">Rp. <?= number_format($order['biaya']) ?></td>
                        <td>
                        ...
                        <td class="font-medium text-gray-900 whitespace-nowrap ">Bank <?= strtoupper($order['payment']) ?></td>
                        <td>
                            <button data-modal-target="verifikasiModal<?= $ordinal ?>" data-modal-toggle="verifikasiModal<?= $ordinal ?>" class="transition cursor-pointer w-full rounded-lg bg-blue-700 px-3 py-2 text-sm font-medium text-white hover:bg-blue-800  :bg-blue-700 lg:w-auto">Verifikasi</button>
                                ...
                                <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
                                    <div class="relative p-5 bg-white rounded-lg shadow  sm:p-6">
                                        ...
                                        <dl>
                                            <div class="text-sm space-y-4 sm:space-y-2 rounded-lg border border-gray-100 bg-gray-50 p-5   mb-6 md:mb-8">
                                                ...
                                                <dl class="sm:flex items-center justify-between gap-4">
                                                    ...
                                                    <dd class="font-medium text-gray-900  sm:text-end"><?= $order['tanggal_sewa'] ?> <?= substr($order['jam_mulai'], 0, 5) ?>-<?= substr($order['jam_selesai'], 0, 5) ?></dd>
                                                </dl>
                                                <dl class="sm:flex items-center justify-between gap-4">
                                        ...
                                        <div>
                                            ...
                                            <button type="button" data-modal-toggle="verifikasiModal<?= $ordinal ?>" class="cursor-pointer py-2.5 w-full px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-200 :ring-gray-700   ">
                                                Tutup
                                            </button>             
                                        </div>
                                    </div>
                        ...
                        <section>
                            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                                <div class="mx-auto max-w-screen-sm text-center">
                                    <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-blue-600 "><i class="fa-solid fa-snooze"></i></h1>
        ...
        <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
            <div class="relative p-5 bg-white rounded-lg shadow  sm:p-6">
                ...
                <div>   
                    <button type="button" data-modal-toggle="buktiModal1" class="cursor-pointer py-2.5 w-full px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-200 :ring-gray-700   ">
                        Tutup
                    </button>             
                </div>
            </div>
